...
class Line(IntFlag):
  ...
  # healing lines are a combination of the type (normal, party, nearby) and what they heal.
...
class LineVariants(IntFlag):
  ...
  HEAL_HP_ONLY_A = HEAL_HP_ONLY | LINE_A | HEAL_NORMAL
  HEAL_HP_ONLY_B = HEAL_HP_ONLY | LINE_B | HEAL_NORMAL
  HEAL_HP_ONLY_C = HEAL_HP_ONLY | LINE_C | HEAL_NORMAL
  HEAL_HP_MP_A = HEAL_HP_MP | LINE_A | HEAL_NORMAL
  HEAL_HP_MP_B = HEAL_HP_MP | LINE_B | HEAL_NORMAL
  HEAL_HP_MP_C = HEAL_HP_MP | LINE_C | HEAL_NORMAL
  HEAL_MP_ONLY_A = HEAL_MP_ONLY | LINE_A | HEAL_NORMAL
  HEAL_MP_ONLY_B = HEAL_MP_ONLY | LINE_B | HEAL_NORMAL
  HEAL_MP_ONLY_C = HEAL_MP_ONLY | LINE_C | HEAL_NORMAL

  HEAL_HP_ONLY_NEAR_A = HEAL_HP_ONLY | LINE_A | HEAL_NEAR
  HEAL_HP_ONLY_NEAR_B = HEAL_HP_ONLY | LINE_B | HEAL_NEAR
  HEAL_HP_ONLY_NEAR_C = HEAL_HP_ONLY | LINE_C | HEAL_NEAR
  HEAL_HP_MP_NEAR_A = HEAL_HP_MP | LINE_A | HEAL_NEAR
  HEAL_HP_MP_NEAR_B = HEAL_HP_MP | LINE_B | HEAL_NEAR
  HEAL_HP_MP_NEAR_C = HEAL_HP_MP | LINE_C | HEAL_NEAR
  HEAL_MP_ONLY_NEAR_A = HEAL_MP_ONLY | LINE_A | HEAL_NEAR
  HEAL_MP_ONLY_NEAR_B = HEAL_MP_ONLY | LINE_B | HEAL_NEAR
  HEAL_MP_ONLY_NEAR_C = HEAL_MP_ONLY | LINE_C | HEAL_NEAR

  HEAL_HP_ONLY_PARTY_A = HEAL_HP_ONLY | LINE_A | HEAL_PARTY
  HEAL_HP_ONLY_PARTY_B = HEAL_HP_ONLY | LINE_B | HEAL_PARTY
  HEAL_HP_ONLY_PARTY_C = HEAL_HP_ONLY | LINE_C | HEAL_PARTY
  HEAL_HP_MP_PARTY_A = HEAL_HP_MP | LINE_A | HEAL_PARTY
  HEAL_HP_MP_PARTY_B = HEAL_HP_MP | LINE_B | HEAL_PARTY
  HEAL_HP_MP_PARTY_C = HEAL_HP_MP | LINE_C | HEAL_PARTY
...
class LineMasks(IntFlag):
  ...
  HEAL_HP = HEAL_HP_ONLY | HEAL_HP_MP
  HEAL_MP = HEAL_MP_ONLY | HEAL_HP_MP
  HEAL_HP_NEAR = HEAL_HP | HEAL_NEAR
  HEAL_HP_PARTY = HEAL_HP | HEAL_PARTY
  HEAL_MP_NEAR = HEAL_MP | HEAL_NEAR
  HEAL_MP_PARTY = HEAL_MP | HEAL_PARTY
